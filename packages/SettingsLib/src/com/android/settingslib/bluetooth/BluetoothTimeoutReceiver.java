...
public class BluetoothTimeoutReceiver extends BroadcastReceiver {
    ...
    public static void setTimeoutAlarm(Context context, long alarmTime) {
        ...
        PendingIntent pending = PendingIntent.getBroadcast(
                context, 0, intent, alarmTime != 0 ? 0 : PendingIntent.FLAG_NO_CREATE);
        ...
        if (pending != null) {
            ...
            Log.d(TAG, "setTimeoutAlarm(): cancel prev alarm");
        }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() == null) {
            return;
        } else if (intent.getAction().equals(INTENT_TIMEOUT)) {
            ...
            if (intent.getIntExtra(BluetoothAdapter.EXTRA_CONNECTION_STATE, 0)
                    == BluetoothAdapter.STATE_DISCONNECTED && bluetoothAdapter != null &&
                    bluetoothAdapter.getState() == BluetoothAdapter.STATE_ON) {
                setTimeoutAlarm(context, Settings.Global.getLong(context.getContentResolver(),
