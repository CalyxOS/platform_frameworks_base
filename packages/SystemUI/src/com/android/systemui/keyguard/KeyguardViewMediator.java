...
public class KeyguardViewMediator implements CoreStartable, Dumpable,
    ...
    private long getLockTimeout(int userId) {
        ...
        final int parentUserId = mSelectedUserInteractor.getSelectedUserId();
        if (userId == parentUserId) {
            ...
            lockAfterTimeoutFallback = mSecureSettings.getIntForUser(
    ...
    private void doKeyguardLaterForChildProfileLocked(final int profileId, final long userTimeout) {
