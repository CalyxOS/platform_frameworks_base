        ...
        public void onOpChanged(String op, String packageName) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(() -> {
                if (!isDestroyed()) {
                    ...
                    // Because finish() is overridden to set the installation result, we must
                    // use the original finish() method; otherwise, the confirmation dialog fails
                    // to appear in real-world usage.
